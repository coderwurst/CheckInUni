...

{
    ...
    private static String url_student_auth = "http://192.168.1.106/xampp/student_attendance/auth_student.php";
    private static String url_staff_auth = "http://192.168.1.106/xampp/student_attendance/auth_staff.php";
    private static String url_device_auth = "http://192.168.1.106/xampp/student_attendance/auth_device.php";
